...
public class Plant2Watering extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plant2_watering);
        wateringDB = new DataBaseHandler(this);

        mAuth = FirebaseAuth.getInstance();

        editNewPlant = (EditText)findViewById(R.id.Plant2Watering_editText_newPlant);
        editNewWaterAmount = (EditText)findViewById(R.id.Plant2Watering_editText_waterAmount);
        editTimeHour = (EditText)findViewById(R.id.Plant2Watering_editText_timeHour);
        editTimeMin = (EditText)findViewById(R.id.Plant2Watering_editText_timeMin);
        editOrdernumber = (EditText)findViewById(R.id.Plant2Watering_editText_Ordernumber);
        editAccountComperer = (EditText)findViewById(R.id.Plant2Watering_editText_accountComperer);

        database = FirebaseDatabase.getInstance();

        databaseReference = database.getReference().child("Bevattningar").child("Plant2");
    ...
    int printValue(int compareOrderValue, int shit){
        Toast.makeText(Plant2Watering.this, compareOrderValue, Toast.LENGTH_SHORT).show();
        return compareOrderValue;
    }

    private void getValues(){

        userInformation_FB_Plant2.setAccount_comperer_plant2(editAccountComperer.getText().toString());
        userInformation_FB_Plant2.setOrder_number_plant2(editOrdernumber.getText().toString());
        userInformation_FB_Plant2.setPlant2(editNewPlant.getText().toString());
        userInformation_FB_Plant2.setWater_amount_plant2(editNewWaterAmount.getText().toString());
        userInformation_FB_Plant2.setTime_hour_plant2(editTimeHour.getText().toString());
        userInformation_FB_Plant2.setTime_min_plant2(editTimeMin.getText().toString());

    }

    public void goToHome_Menu_Plant2(View view){
    ...
    public void goToBevattning_Plant2(View view){
    ...
    public void showTime1(){
        time_picker = (TimePicker)findViewById(R.id.Plant2Watering_timePicker);
        approveTime_button1 = (Button)findViewById(R.id.Plant2Watering_approveTime_button);
        stateTime1 = (TextView)findViewById(R.id.Plant2Watering_statedTime_text);
    ...
    public void seekbar_1() {
        seek_bar1 = (SeekBar) findViewById(R.id.Plant2Watering_seekBar1);
        seek_bar1.setMax(10000);
        stateWater1 = (TextView) findViewById(R.id.Plant2Watering_stateWaterAmount_fill);
        ...
        seek_bar1.setOnSeekBarChangeListener(
                new SeekBar.OnSeekBarChangeListener() {
                    ...
                    public void onStopTrackingTouch(SeekBar Plant1Watering_seekBar1) {
                        ...
                        acceptWaterAmount_button1 = (Button) findViewById(R.id.Plant2Watering_acceptWaterAmount_button);
                        acceptWaterAmount_button1.setOnClickListener(
                                new View.OnClickListener() {
                                    public void onClick(View v) {
                                        stateWater2 = (TextView) findViewById(R.id.Plant2Watering_acceptedWaterAmount_text);
                                        stateWater2.setText("Angiven vattenmängd: " + progress_value);
                                    }
                                }
                        );
                        approveFinalParameters_button1 = (Button)findViewById(R.id.Plant2Watering_approveWatering_button);
                        time_picker = (TimePicker)findViewById(R.id.Plant2Watering_timePicker);
                        approveFinalParameters_button1.setOnClickListener(
                                new View.OnClickListener(){
                                    public void onClick(View v){
                                        finalParameters1 = (TextView)findViewById(R.id.Plant2Watering_showFinalParameters_text);
 ...
 */
                                        ...
                                        if(TextUtils.isEmpty(plant)) {
                                            Toast.makeText(Plant2Watering.this, "Ingen planta", Toast.LENGTH_SHORT).show();
                                        }
                                        else if(TextUtils.isEmpty(water_amount)){
                                            Toast.makeText(Plant2Watering.this, "Ingen vattenmängd", Toast.LENGTH_SHORT).show();
                                        }
                                        else if(TextUtils.isEmpty(time_hour)){
                                            Toast.makeText(Plant2Watering.this, "Ingen inställd tid", Toast.LENGTH_SHORT).show();
                                            ...
                                            Toast.makeText(Plant2Watering.this, "Inget ordernummer", Toast.LENGTH_SHORT).show();
                                        }
                                        else {
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(
                                                    new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            ...
                                                            plant2Values = new int[plant2SizeMax];
                                                            for(DataSnapshot ds: dataSnapshot.getChildren()){
                                                                ...
                                                                compareAccountComperer = Integer.parseInt(userInformation_FB_Plant2.getAccount_comperer_plant2().toString());
                                                                ...
                                                                plant2Comperer = Integer.parseInt(userInformation_FB_Plant2.getPlant2().toString());
                                                                if(plant2Comperer == 2){
                                                                    plant2Values[plant2Counter++] = plant2Comperer;
                                                                }
                                                          ...
                                                          //  Toast.makeText(Plant2Watering.this, "What IN HELL IS: " + databaseCounter, Toast.LENGTH_SHORT).show();
                                                            ...
                                                            if(databaseCounter < 9 && plant2Counter < 9) {
                                                                Toast.makeText(Plant2Watering.this, "Bevattning tillagd.", Toast.LENGTH_SHORT).show();
                                                                for (int m = 2; m < countedValues; m++) {
                                                                    ...
                                                                    if ((databaseValues[m - 1] - databaseValues[m - 2]) > 1 && overflowCounter == 1 && databaseValues[m - 2] == 1) {
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant2Watering.this, "THIS SUCKS", Toast.LENGTH_SHORT).show();
                                                                        editOrdernumber.setText("Schemalaggning-" + (databaseValues[m - 2] + 1));
                                                                        editAccountComperer.setText("" + (databaseValues[m - 2] + 1));
                                                                        getValues();
                                                                        databaseReference.child(userInformation_FB_Plant2.getOrder_number_plant2()).setValue(userInformation_FB_Plant2);
                                                                    } else if ((databaseValues[m - 1] - databaseValues[m - 2]) > 1 && overflowCounter == 1 && databaseValues[m - 2] != 1) {
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant2Watering.this, "AWESOME", Toast.LENGTH_SHORT).show();
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant2Watering.this, "AWESOME111", Toast.LENGTH_SHORT).show();
                                                                        editOrdernumber.setText("Schemalaggning-" + (databaseValues[m-1] - databaseValues[m-1] + 1));
                                                                        editAccountComperer.setText("" + (databaseValues[m-1] - databaseValues[m-1] + 1));
                                                                        getValues();
                                                                        databaseReference.child(userInformation_FB_Plant2.getOrder_number_plant2()).setValue(userInformation_FB_Plant2);
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant2Watering.this, "AWESOME112", Toast.LENGTH_SHORT).show();
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant2Watering.this, "AWESOME113", Toast.LENGTH_SHORT).show();
                                                                        editOrdernumber.setText("Schemalaggning-" + (databaseValues[m-1] + 1));
                                                                        editAccountComperer.setText("" + (databaseValues[m-1] + 1));
                                                                        getValues();
                                                                        databaseReference.child(userInformation_FB_Plant2.getOrder_number_plant2()).setValue(userInformation_FB_Plant2);
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant2Watering.this, "AWESOME22", Toast.LENGTH_SHORT).show();
                                                                        editOrdernumber.setText("Schemalaggning-" + (databaseValues[m - 1] - databaseValues[m - 1] + 1));
                                                                        editAccountComperer.setText("" + (databaseValues[m - 1] - databaseValues[m - 1] + 1));
                                                                        getValues();
                                                                        databaseReference.child(userInformation_FB_Plant2.getOrder_number_plant2()).setValue(userInformation_FB_Plant2);
                                                                    ...
                                                                    // VERIFIED WORKS
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant2Watering.this, "AWESOME33", Toast.LENGTH_SHORT).show();
                                                                        editOrdernumber.setText("Schemalaggning-" + (databaseValues[m - 1] + 1));
                                                                        editAccountComperer.setText("" + (databaseValues[m - 1] + 1));
                                                                        getValues();
                                                                        databaseReference.child(userInformation_FB_Plant2.getOrder_number_plant2()).setValue(userInformation_FB_Plant2);
                                                                ...
                                                                if (databaseValues[0] == 1 && databaseValues[1] == 0 && overflowCounter == 1) {
                                                                    overflowCounter++;
                                                                    Toast.makeText(Plant2Watering.this, "DUDESTAR", Toast.LENGTH_SHORT).show();
                                                                    ...
                                                                    overflowCounter++;
                                                                    Toast.makeText(Plant2Watering.this, "DUDEFAIL", Toast.LENGTH_SHORT).show();
                                                                    editOrdernumber.setText("Schemalaggning-" + (databaseValues[0] - databaseValues[0] + 1));
                                                                    editAccountComperer.setText("" + (databaseValues[0] - databaseValues[0] + 1));
                                                                    getValues();
                                                                    databaseReference.child(userInformation_FB_Plant2.getOrder_number_plant2()).setValue(userInformation_FB_Plant2);
                                                                ...
                                                                Toast.makeText(Plant2Watering.this, "Maximalt antal bevattningar i systemet. Går inte att lägga till fler innan en annan bevattning har påbörjats.", Toast.LENGTH_LONG).show();
                                                            }
                                                           // }
 ...
 */
                                        ...
                                        if(isInserted == true)
                                            Toast.makeText(Plant2Watering.this,
                                                ""
                                                //    "Förfrågan tillagd"
                                                    , Toast.LENGTH_SHORT).show();
                                        else
                                            Toast.makeText(Plant2Watering.this, "Gick inte att lägga till", Toast.LENGTH_SHORT).show();

                                    }
                                }
                        );

                        changeFinalParameters_button1 = (Button)findViewById(R.id.Plant2Watering_approveChange_button);
                        time_picker = (TimePicker)findViewById(R.id.Plant2Watering_timePicker);
                        ...
                        changeFinalParameters_button1.setOnClickListener(
                                new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        if(isUpdate == true)
                                            Toast.makeText(Plant2Watering.this, "Uppdatering utförd", Toast.LENGTH_LONG).show();
                                        else
                                            Toast.makeText(Plant2Watering.this, "Gick inte att uppdatera", Toast.LENGTH_LONG).show();
                        ...
                        deleteFinalParameters_button1 = (Button)findViewById(R.id.Plant2Watering_approveDelete_button);
                        time_picker = (TimePicker)findViewById(R.id.Plant2Watering_timePicker);
                                ...
                                new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        Integer deletedRows = wateringDB.deleteData(
                                                editOrdernumber.getText().toString());
                                        if(deletedRows > 0)
                                            Toast.makeText(Plant2Watering.this, "Bevattning borttagen", Toast.LENGTH_LONG).show();
                                        else
                                            Toast.makeText(Plant2Watering.this, "Kunde inte hitta data", Toast.LENGTH_LONG).show();
                                    }
                                }
