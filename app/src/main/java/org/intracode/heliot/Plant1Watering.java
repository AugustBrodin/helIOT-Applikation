...
public class Plant1Watering extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plant1_watering);
        wateringDB = new DataBaseHandler(this);

        mAuth = FirebaseAuth.getInstance();

        editNewPlant = (EditText)findViewById(R.id.Plant1Watering_editText_newPlant);
        editNewWaterAmount = (EditText)findViewById(R.id.Plant1Watering_editText_waterAmount);
        editTimeHour = (EditText)findViewById(R.id.Plant1Watering_editText_timeHour);
        editTimeMin = (EditText)findViewById(R.id.Plant1Watering_editText_timeMin);
        editOrdernumber = (EditText)findViewById(R.id.Plant1Watering_editText_Ordernumber);
        editAccountComperer = (EditText)findViewById(R.id.Plant1Watering_editText_accountComperer);

        database = FirebaseDatabase.getInstance();

        databaseReference = database.getReference().child("Bevattningar").child("Plant1");
    ...
    int printValue(int compareOrderValue, int shit){
        Toast.makeText(Plant1Watering.this, compareOrderValue, Toast.LENGTH_SHORT).show();
        return compareOrderValue;
    }

    private void getValues(){

        userInformation_FB_Plant1.setAccount_comperer_plant1(editAccountComperer.getText().toString());
        userInformation_FB_Plant1.setOrder_number_plant1(editOrdernumber.getText().toString());
        userInformation_FB_Plant1.setPlant1(editNewPlant.getText().toString());
        userInformation_FB_Plant1.setWater_amount_plant1(editNewWaterAmount.getText().toString());
        userInformation_FB_Plant1.setTime_hour_plant1(editTimeHour.getText().toString());
        userInformation_FB_Plant1.setTime_min_plant1(editTimeMin.getText().toString());

    }

    public void goToHome_Menu_Plant1(View view){
    ...
    public void goToBevattning_Plant1(View view){
    ...
    public void showTime1(){
        time_picker = (TimePicker)findViewById(R.id.Plant1Watering_timePicker);
        approveTime_button1 = (Button)findViewById(R.id.Plant1Watering_approveTime_button);
        stateTime1 = (TextView)findViewById(R.id.Plant1Watering_statedTime_text);
    ...
    public void seekbar_1() {
        seek_bar1 = (SeekBar) findViewById(R.id.Plant1Watering_seekBar1);
        seek_bar1.setMax(10000);
        stateWater1 = (TextView) findViewById(R.id.Plant1Watering_stateWaterAmount_fill);
                   ...
                   //     Toast.makeText(Plant1Watering.this, "SeekBar in StartTracking", Toast.LENGTH_SHORT).show();
                    ...
                    public void onStopTrackingTouch(SeekBar Plant1Watering_seekBar1) {
                       ...
                       // Toast.makeText(Plant1Watering.this, "SeekBar in StopTracking", Toast.LENGTH_SHORT).show();
                        acceptWaterAmount_button1 = (Button) findViewById(R.id.Plant1Watering_acceptWaterAmount_button);
                        acceptWaterAmount_button1.setOnClickListener(
                                new View.OnClickListener() {
                                    public void onClick(View v) {
                                        stateWater2 = (TextView) findViewById(R.id.Plant1Watering_acceptedWaterAmount_text);
                                        stateWater2.setText("Angiven vattenmängd: " + progress_value);
                                    }
                                }
                        );
                        approveFinalParameters_button1 = (Button)findViewById(R.id.Plant1Watering_approveWatering_button);
                        time_picker = (TimePicker)findViewById(R.id.Plant1Watering_timePicker);
                        approveFinalParameters_button1.setOnClickListener(
                                new View.OnClickListener(){
                                    public void onClick(View v){
                                        finalParameters1 = (TextView)findViewById(R.id.Plant1Watering_showFinalParameters_text);
...
*/
                                        ...
                                        if(TextUtils.isEmpty(plant)) {
                                            Toast.makeText(Plant1Watering.this, "Ingen planta", Toast.LENGTH_SHORT).show();
                                        }
                                        else if(TextUtils.isEmpty(water_amount)){
                                            Toast.makeText(Plant1Watering.this, "Ingen vattenmängd", Toast.LENGTH_SHORT).show();
                                        }
                                        else if(TextUtils.isEmpty(time_hour)){
                                            Toast.makeText(Plant1Watering.this, "Ingen inställd tid", Toast.LENGTH_SHORT).show();
                                            ...
                                            Toast.makeText(Plant1Watering.this, "Inget ordernummer", Toast.LENGTH_SHORT).show();
                                        }
                                        else {
                                                        ...
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            ...
                                                            for(DataSnapshot ds: dataSnapshot.getChildren()){
                                                               // getValues();
                                                                ...
                                                                compareAccountComperer = Integer.parseInt(userInformation_FB_Plant1.getAccount_comperer_plant1().toString());
                                                                ...
                                                                plant1Comperer = Integer.parseInt(userInformation_FB_Plant1.getPlant1().toString());
                                                                if(plant1Comperer == 1){
                                                                    plant1Values[plant1Counter++] = plant1Comperer;
                                                                }
                                                            ...
                                                            if(databaseCounter < 9 && plant1Counter < 9) {
                                                                ...
                                                                for (int m = 2; m < countedValues; m++) {
                                                                    ...
                                                                    if ((databaseValues[m - 1] - databaseValues[m - 2]) > 1 && overflowCounter == 1 && databaseValues[m - 2] == 1) {
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant1Watering.this, "THIS SUCKS", Toast.LENGTH_SHORT).show();
                                                                        editOrdernumber.setText("Schemalaggning-" + (databaseValues[m - 2] + 1));
                                                                        editAccountComperer.setText("" + (databaseValues[m - 2] + 1));
                                                                        getValues();
                                                                        databaseReference.child(userInformation_FB_Plant1.getOrder_number_plant1()).setValue(userInformation_FB_Plant1);
                                                                    } else if ((databaseValues[m - 1] - databaseValues[m - 2]) > 1 && overflowCounter == 1 && databaseValues[m - 2] != 1) {
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant1Watering.this, "AWESOME", Toast.LENGTH_SHORT).show();
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant1Watering.this, "AWESOME111", Toast.LENGTH_SHORT).show();
                                                                        editOrdernumber.setText("Schemalaggning-" + (databaseValues[m-1] - databaseValues[m-1] + 1));
                                                                        editAccountComperer.setText("" + (databaseValues[m-1] - databaseValues[m-1] + 1));
                                                                        getValues();
                                                                        databaseReference.child(userInformation_FB_Plant1.getOrder_number_plant1()).setValue(userInformation_FB_Plant1);
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant1Watering.this, "AWESOME112", Toast.LENGTH_SHORT).show();
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant1Watering.this, "AWESOME113", Toast.LENGTH_SHORT).show();
                                                                        editOrdernumber.setText("Schemalaggning-" + (databaseValues[m-1] + 1));
                                                                        editAccountComperer.setText("" + (databaseValues[m-1] + 1));
                                                                        getValues();
                                                                        databaseReference.child(userInformation_FB_Plant1.getOrder_number_plant1()).setValue(userInformation_FB_Plant1);
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant1Watering.this, "AWESOME22", Toast.LENGTH_SHORT).show();
                                                                        editOrdernumber.setText("Schemalaggning-" + (databaseValues[m - 1] - databaseValues[m - 1] + 1));
                                                                        editAccountComperer.setText("" + (databaseValues[m - 1] - databaseValues[m - 1] + 1));
                                                                        getValues();
                                                                        databaseReference.child(userInformation_FB_Plant1.getOrder_number_plant1()).setValue(userInformation_FB_Plant1);
                                                                    ...
                                                                    // VERIFIED WORKS
                                                                        ...
                                                                        overflowCounter++;
                                                                        Toast.makeText(Plant1Watering.this, "AWESOME33", Toast.LENGTH_SHORT).show();
                                                                        editOrdernumber.setText("Schemalaggning-" + (databaseValues[m - 1] + 1));
                                                                        editAccountComperer.setText("" + (databaseValues[m - 1] + 1));
                                                                        getValues();
                                                                        databaseReference.child(userInformation_FB_Plant1.getOrder_number_plant1()).setValue(userInformation_FB_Plant1);
                                                                ...
                                                                if (databaseValues[0] == 1 && databaseValues[1] == 0 && overflowCounter == 1) {
                                                                    overflowCounter++;
                                                                    Toast.makeText(Plant1Watering.this, "DUDESTAR", Toast.LENGTH_SHORT).show();
                                                                    ...
                                                                    overflowCounter++;
                                                                    Toast.makeText(Plant1Watering.this, "DUDEFAIL", Toast.LENGTH_SHORT).show();
                                                                    editOrdernumber.setText("Schemalaggning-" + (databaseValues[0] - databaseValues[0] + 1));
                                                                    editAccountComperer.setText("" + (databaseValues[0] - databaseValues[0] + 1));
                                                                    getValues();
                                                                    databaseReference.child(userInformation_FB_Plant1.getOrder_number_plant1()).setValue(userInformation_FB_Plant1);
                                                                ...
                                                                Toast.makeText(Plant1Watering.this, "Maximalt antal bevattningar i systemet. Går inte att lägga till fler innan en annan bevattning har påbörjats.", Toast.LENGTH_LONG).show();
                                                            }
                                                            ...
                                                            if(compareAccountComperer != 0) {
                                                                editOrdernumber.setText("Schemalaggning-" + Integer.toString(compareAccountComperer));
                                                                editAccountComperer.setText(Integer.toString(compareAccountComperer));
                                                                Toast.makeText(Plant1Watering.this, "" + compareAccountComperer, Toast.LENGTH_SHORT).show();
                                                                getValues();
                                                                databaseReference.child(userInformation_FB.getOrder_number()).setValue(userInformation_FB);
                                                                //databaseReference.child(userInformation_FB.getAccount_comperer()).setValue(userInformation_FB);
                                                            }
...
*/
                                        ...
                                        if(isInserted == true)
                                            Toast.makeText(Plant1Watering.this, "Förfrågan tillagd", Toast.LENGTH_SHORT).show();
                                        else
                                            Toast.makeText(Plant1Watering.this, "Gick inte att lägga till", Toast.LENGTH_SHORT).show();

                                      }
                                   }
                        );

                        changeFinalParameters_button1 = (Button)findViewById(R.id.Plant1Watering_approveChange_button);
                        time_picker = (TimePicker)findViewById(R.id.Plant1Watering_timePicker);
                                ...
                                new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                       ...
                                       boolean isUpdate = wateringDB.updateData(
                                        ...
                                        if(isUpdate == true)
                                            Toast.makeText(Plant1Watering.this, "Uppdatering utförd", Toast.LENGTH_LONG).show();
                                        else
                                            Toast.makeText(Plant1Watering.this, "Gick inte att uppdatera", Toast.LENGTH_LONG).show();
                        ...
                        deleteFinalParameters_button1 = (Button)findViewById(R.id.Plant1Watering_approveDelete_button);
                        time_picker = (TimePicker)findViewById(R.id.Plant1Watering_timePicker);
                                ...
                                new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        Integer deletedRows = wateringDB.deleteData(
                                                editOrdernumber.getText().toString());
                                        if(deletedRows > 0)
                                            Toast.makeText(Plant1Watering.this, "Bevattning borttagen", Toast.LENGTH_LONG).show();
                                        else
                                            Toast.makeText(Plant1Watering.this, "Kunde inte hitta data", Toast.LENGTH_LONG).show();
                                    }
                                }
